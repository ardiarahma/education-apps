...
import com.ardiarahma.education.adapters.RV_EbookSubject8Adapter;
import com.ardiarahma.education.models.EbookSubject;

import java.util.ArrayList;
import java.util.List;

public class FragmentEbookSubject8 extends Fragment {

    List<EbookSubject> ebook_subjects;

    public FragmentEbookSubject8() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RV_EbookSubject8Adapter adapter = new RV_EbookSubject8Adapter(getContext(), ebook_subjects);
