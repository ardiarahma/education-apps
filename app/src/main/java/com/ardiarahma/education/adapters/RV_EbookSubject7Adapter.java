...
import com.ardiarahma.educationapplication.activities.EbookShelvesActivity;
...
public class RV_EbookSubject7Adapter extends RecyclerView.Adapter<RV_EbookSubject7Adapter.ViewHolder> {
    ...
    public RV_EbookSubject7Adapter(Context context, List<EbookSubject> ebookSubjects) {
...
//        int drr = random.nextInt(10 - 1) + 1;
//        int randomInt = drr;
//        int drawableId = imgs.getResourceId(randomInt, 0);
//
//        holder.title_bg.setBackgroundResource(drawableId);
