...
public class RV_BanksoalSubject9Adapter extends RecyclerView.Adapter<RV_BanksoalSubject9Adapter.ViewHolder> {

    Context context;
    int classes = 9;
    List<BanksoalSubject> banksoalSubjects;

    public RV_BanksoalSubject9Adapter(Context context, List<BanksoalSubject> banksoalSubjects) {
