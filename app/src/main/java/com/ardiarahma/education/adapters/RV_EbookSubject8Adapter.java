...
public class RV_EbookSubject8Adapter extends RecyclerView.Adapter<RV_EbookSubject8Adapter.ViewHolder> {
    ...
    public RV_EbookSubject8Adapter(Context context, List<EbookSubject> ebookSubjects) {
