...
import com.ardiarahma.educationapplication.activities.BanksoalShelvesActivity;
import com.ardiarahma.educationapplication.models.BanksoalSubject;
...
public class RV_BanksoalSubject7Adapter extends RecyclerView.Adapter<RV_BanksoalSubject7Adapter.ViewHolder> {

    Context context;
    int classes = 7;
    List<BanksoalSubject> banksoalSubjects;

    public RV_BanksoalSubject7Adapter(Context context, List<BanksoalSubject> banksoalSubjects) {
